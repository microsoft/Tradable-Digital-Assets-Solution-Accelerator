$resourceGroupName = 'Blockchain_TradableAsset_Acceleratorzxc'
$location = 'West US 2'
 $subscriptionID = '8bcea3a6-66c0-4cb4-be1f-21e3b44efaaf'
# $subscriptionID = 'dbd9230d-b929-45a9-99c3-f2c003d9c1b8'
$azurecosmoaccount = 'digitalgoodszxc'
$azurecosmosaccountapp = 'digitalgoods-appzxc'
$storageAccountName = 'digitalgoodstoragezxc' 
$keyvaultname = 'ContosoDigitalGoodsVaultszxc'
$containerregistry = 'ContosoDigitalGoodszxc'
$kubernateservice = 'kubeContosoDigitalGoodszxc'
$azureblockchaineservice = 'member01digitalgoodszxc'
