...
namespace Microsoft.TokenService.LedgerClient.nFmbtgToken
{
    public partial class NFmbtgTokenService
    {
        ...
        public static async Task<NFmbtgTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, NFmbtgTokenDeployment nFmbtgTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, nFmbtgTokenDeployment, cancellationTokenSource);
            return new NFmbtgTokenService(web3, receipt.ContractAddress);
        }
        ...
        public NFmbtgTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
