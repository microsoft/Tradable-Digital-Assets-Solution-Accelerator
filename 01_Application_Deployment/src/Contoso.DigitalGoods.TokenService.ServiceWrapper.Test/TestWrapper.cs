...
namespace Contoso.DigitalGoods.TokenService.ServiceWrapper.Test
{
    ...
    public class TestWrapper : TestBase
    {
        ...
        //const string UserA = 
        //const string UserB = Config["Values:UserB_ABTID"];
        ...
        public void InitTest()
        {
            ...
            _svcWrapper = new TokenServiceWrapper(_endpointUrl);
            _accountSvcWrapper = new AccountServiceWrapper(_endpointUrl, Config["Values:PartyID"], Config["Values:BlockchainNetworkID"]);
            _tokenID = Config["Values:TokenID"];
            _userA = Config["Values:UserA_ABTID"]; 
