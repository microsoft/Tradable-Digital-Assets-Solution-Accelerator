...
namespace Contoso.DigitalGoods.TokenService
{
    public class TokenManager
    {
        ...
        public TokenManager(string DBConnectionString, string ServiceEndpoint)
        {
            ...
            tokenServiceWrapper = new TokenServiceWrapper(ServiceEndpoint);
        ...
        /// <returns></returns>
        public async Task<DigitalKickToken> MintToken(string TokenID, string TokenMinter, string RecipientID, DigitalKickToken tokenInfo)
        {
