...
namespace Contoso.DigitalGoods.Application.API.Controllers
{
    ...
    public class UserProfileController : ControllerBase
    {
        ...
        /// <summary>
        /// Provisioning User's Digital Locker and Registering ABT User ID
        /// </summary>
        ...
        /// <summary>
        /// Return ABT UserID from ContosoIdentifier
        /// </summary>
        /// <param name="ContosoIdentifier"></param>
        /// <returns></returns>
        [HttpGet]
        [Route("{ContosoIdentifier}")]
        public IMessage<Model.ContosoProfile> GetABTUserID(string ContosoIdentifier)
        {
